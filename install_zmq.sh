...
ZMQ_VERSION=4.3.4
PYTHON_BIN=$(which python)   # Gets the full path of the current python interpreter
PREFIX=$(dirname $(dirname $PYTHON_BIN))  # Gets the parent directory of the python binary's directory
PYZMQ=${PYZMQ:-pyzmq}
